...
# Check liquidity pool reserves on Base Sepolia
...
echo "=============================================="
echo "Liquidity Pool Reserves on Base Sepolia"
echo "=============================================="
echo ""
...
if [ -n "$PAIR_IDRX_USDC" ]; then
    ...
    RESERVES=$(cast call $PAIR_IDRX_USDC "getReserves()" --rpc-url $BASE_SEPOLIA_RPC)
...
if [ -n "$PAIR_XAUT_USDC" ]; then
    ...
    RESERVES=$(cast call $PAIR_XAUT_USDC "getReserves()" --rpc-url $BASE_SEPOLIA_RPC)
