...
# Simulate deposit and borrow on Base Sepolia
...
echo "=============================================="
echo "Simulate Deposit and Borrow on Base Sepolia"
echo "=============================================="
echo "User: $USER"
...
# Check KYC
IS_VERIFIED=$(cast call $IDENTITY_REGISTRY "isVerified(address)" $USER --rpc-url $BASE_SEPOLIA_RPC)
...
# Check XAUT balance
XAUT_BALANCE=$(cast call $XAUT "balanceOf(address)" $USER --rpc-url $BASE_SEPOLIA_RPC)
...
# Show new position
echo "New position:"
./script/base/helper/check-balances.sh $USER
