...
# Mint IDRX tokens on Base Sepolia
...
echo "=============================================="
echo "Minting IDRX on Base Sepolia"
echo "=============================================="
...
# Get balance before
BALANCE_BEFORE=$(cast call $MOCK_IDRX "balanceOf(address)" $RECIPIENT --rpc-url $BASE_SEPOLIA_RPC)
...
# Get balance after
BALANCE_AFTER=$(cast call $MOCK_IDRX "balanceOf(address)" $RECIPIENT --rpc-url $BASE_SEPOLIA_RPC)
